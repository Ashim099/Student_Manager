...
SECRET_KEY = '3hcct-!3xyil9b^5%dy#!-f_mrc(mi1o#i*d8$rj)4&5($$j-x'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.getenv('ashimpoudel1357@gmail.com')
EMAIL_HOST_PASSWORD = os.getenv('nvqm alaw vzym seoz')
