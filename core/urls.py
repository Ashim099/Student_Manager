...
from .views import (
    ...
    create_reminder, student_edit_reminder, student_delete_reminder,student_course_recommendation, search_course_recommendation,student_gpa_prediction
)
...
urlpatterns = [
    ...
    path('student/create-reminder/', create_reminder, name='create_reminder'),
